...
# finds # of bits for 24 bits colour 
def image_bits():
...
# Display instructions if user  has not used the peogram before 
first_time = input("Press <enter> to see this instruction or any key to continue")
